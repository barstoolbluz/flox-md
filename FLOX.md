...
- **Run services in containers** → §8 (Services)
...
- **Use environment variable conventions** → §14 (Environment Variables)
...
**Example:** Layer debugging tools (`flox activate -r team/debugging`) on base development environment for ad-hoc development.
...
**Note**: Use Metal-accelerated packages on Darwin when available for GPU workloads.
